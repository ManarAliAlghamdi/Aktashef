...
struct ContryContent_UK: View {
    ...
    func contentForTab(_ tab: String) -> String {
        switch tab {
        case "نبذة":
            return "بريطانيا، اللي تُعرف أيضاً بالمملكة المتحدة، تتكون من أربع دول: إنجلترا، اسكتلندا، ويلز، وأيرلندا الشمالية. لندن هي العاصمة وتعتبر واحدة من أكبر المدن في العالم. عندهم تاريخ طويل وغني، بدءاً من العصور الوسطى إلى الثورة الصناعية. \nالمناخ في بريطانيا غالباً معتدل وممطر، وهذا يجعل الطبيعة\n فيها خضراء وخلابة. البريطانيين معروفين بأدبهم واهتمامهم بالثقافة، وتلقاهم يحبون الفنون والموسيقى. عندهم تقاليد عريقة، مثل احتفالات عيد الميلاد وعيد الفصح، والاحتفال بالزفاف الملكي، اللي يجذب انتباه العالم."
        case "الأكل":
